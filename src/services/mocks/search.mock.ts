...
/**
 * 검색 더미 ContentCardData (app/search/_mock/contents.ts에서 복사)
 */
const mockSearchContents: ContentCardData[] = [
  {
    id: 1,
    rating: 4.8,
    tags: {
...
const convertContentCardToSearchResultItem = (
  ...
  return {
    ...
    imageSrc:
      typeof content.imageSrc === 'string'
        ? content.imageSrc
...
/**
 * 검색 결과 Model 반환 (목업 모드용)
 * SearchResultModel을 직접 반환합니다.
 */
